...
const DoctorDashboard = () => {
    ...
    return (
        <div className="bg-primary-dark min-h-full pt-20 md:pt-24 pb-8 md:pb-12 px-4">
            <div className="container mx-auto">
                <div className="mb-8 md:mb-12">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4 mb-4">
                        ...
                        {isPro && (
                            <span className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-black px-3 md:px-4 py-1 md:py-2 rounded-full text-xs md:text-sm font-bold flex items-center gap-2">
                                ⭐ PRO MEMBER
                            </span>
                        )}
                    </div>
                ...
                {!loading && !isPro && ['doctor', 'nurse'].includes(user?.role) && (
                    <div className="mb-6 md:mb-8 bg-gradient-to-r from-blue-600 to-purple-600 p-4 md:p-6 rounded-xl shadow-lg">
                        <div className="flex flex-col md:flex-row items-center justify-between">
                            ...
                            <Link
                                to="/upgrade-pro"
                                className="bg-white text-blue-600 px-4 md:px-6 py-2 md:py-3 rounded-lg font-bold hover:bg-blue-50 transition text-sm md:text-base"
                            >
                                Upgrade Now
                            </Link>
                        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
                    {/* Quick Links */}
                    <div className="lg:col-span-1 bg-secondary-dark p-4 md:p-6 rounded-xl shadow-lg h-fit">
                    ...
                    <div className="lg:col-span-2 bg-secondary-dark p-4 md:p-6 rounded-xl shadow-lg">
                        <h2 className="text-xl md:text-2xl font-bold text-white mb-4">
                            Today's Schedule
                        </h2>
